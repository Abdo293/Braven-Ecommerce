...
export const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white">
      <div className="container mx-auto max-md:px-3 px-6 py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <Links className="text-gray-300 hover:text-white transition-colors duration-200 text-sm" />
            </ul>
          </div>
